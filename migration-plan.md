...
<migration-log>
  ...
  <pr id="18" branch="staging (direct commits — Railway watch branch; see deviations)"
    ...
    <known-risks>
      ...
      - **Discovery (owner: "unacceptable") — UNTOUCHED this session:** only components/ui + animate-ui surface; REV's components/plugin (22) not discovered. Needs co-design with the owner (heuristic + explicit config + interactive picker). PR19.
